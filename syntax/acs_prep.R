...
acs_county_2018 <- get_acs(
  ...
  mutate(r_white = B02001_002/B02001_001,
         ...
         avg_travel = B08136_002/B02001_001,
         ...
         ed_ls_hs = (B15003_002 + B15003_003 + B15003_004 + B15003_005 +
         ...
         ed_advanced = (B15003_023 + B15003_024 + B15003_025)/B15003_001,
         log_pop = log(B02001_001), 
         year = 2018 ) |>
  select(year, county = NAME, county_fips = GEOID, median_income = B21004_001,
         med_hh_income = B19013_001, med_age = B01002_001, 
         med_rooms = B25018_001, avg_travel, 
         med_home_val = B25077_001, r_white:log_pop) 
